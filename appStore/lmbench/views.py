    ...
    def get_data(self, serializer_, datas, title_index, column_index, base_column_index):
        ...
        if len(serializer_) <= 1:
            if len(serializer_) == 0:
                ...
                datas[9]['column' + str(column_index)] = serializer.data[0]['processor_null_call']
                datas[10]['column' + str(column_index)] = serializer.data[0]['processor_null_I_O']
                datas[11]['column' + str(column_index)] = serializer.data[0]['processor_stat']
                datas[12]['column' + str(column_index)] = serializer.data[0]['processor_open_close']
                datas[13]['column' + str(column_index)] = serializer.data[0]['processor_slct_TCP']
                datas[14]['column' + str(column_index)] = serializer.data[0]['processor_sig_inst']
                datas[15]['column' + str(column_index)] = serializer.data[0]['processor_sig_hndl']
                datas[16]['column' + str(column_index)] = serializer.data[0]['processor_fork_proc']
                datas[17]['column' + str(column_index)] = serializer.data[0]['processor_exec_proc']
                datas[18]['column' + str(column_index)] = serializer.data[0]['processor_sh_proc']
                datas[19]['column' + str(column_index)] = serializer.data[0]['processor_Mhz']
            ...
            for data in serializer_:
                ...
                datas[9]['column' + str(column_index)] = data.processor_null_call
                datas[10]['column' + str(column_index)] = data.processor_null_I_O
                datas[11]['column' + str(column_index)] = data.processor_stat
                datas[12]['column' + str(column_index)] = data.processor_open_close
                datas[13]['column' + str(column_index)] = data.processor_slct_TCP
                datas[14]['column' + str(column_index)] = data.processor_sig_inst
                datas[15]['column' + str(column_index)] = data.processor_sig_hndl
                datas[16]['column' + str(column_index)] = data.processor_fork_proc
                datas[17]['column' + str(column_index)] = data.processor_exec_proc
                datas[18]['column' + str(column_index)] = data.processor_sh_proc
                datas[19]['column' + str(column_index)] = data.processor_Mhz
            ...
            datas[9]['column' + str(column_index)] = average_processor_null_call
            datas[10]['column' + str(column_index)] = average_processor_null_I_O
            datas[11]['column' + str(column_index)] = average_processor_stat
            datas[12]['column' + str(column_index)] = average_processor_open_close
            datas[13]['column' + str(column_index)] = average_processor_slct_TCP
            datas[14]['column' + str(column_index)] = average_processor_sig_inst
            datas[15]['column' + str(column_index)] = average_processor_sig_hndl
            datas[16]['column' + str(column_index)] = average_processor_fork_proc
            datas[17]['column' + str(column_index)] = average_processor_exec_proc
            datas[18]['column' + str(column_index)] = average_processor_sh_proc
            datas[19]['column' + str(column_index)] = average_processor_Mhz
            ...
            datas[49]['column' + str(column_index)] = average_local_TCP
