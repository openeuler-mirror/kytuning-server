    ...
    def get_data(self, serializer_, datas, title_index, column_index, base_column_index):
        ...
        if len(serializer_) <= 1:
            if len(serializer_) == 0:
                ...
                datas[5]['column' + str(column_index)] = serializer.data[0]['basic_tlb_pages']
                datas[6]['column' + str(column_index)] = serializer.data[0]['basic_cache_line_bytes']
                datas[7]['column' + str(column_index)] = serializer.data[0]['basic_mem_par']
                datas[8]['column' + str(column_index)] = serializer.data[0]['basic_scal_load']
                datas[9]['column' + str(column_index)] = serializer.data[0]['processor_Mhz']
                datas[10]['column' + str(column_index)] = serializer.data[0]['processor_null_call']
                datas[11]['column' + str(column_index)] = serializer.data[0]['processor_null_I_O']
                datas[12]['column' + str(column_index)] = serializer.data[0]['processor_stat']
                datas[13]['column' + str(column_index)] = serializer.data[0]['processor_open_close']
                datas[14]['column' + str(column_index)] = serializer.data[0]['processor_slct_TCP']
                datas[15]['column' + str(column_index)] = serializer.data[0]['processor_sig_inst']
                datas[16]['column' + str(column_index)] = serializer.data[0]['processor_sig_hndl']
                datas[17]['column' + str(column_index)] = serializer.data[0]['processor_fork_proc']
                datas[18]['column' + str(column_index)] = serializer.data[0]['processor_exec_proc']
                datas[19]['column' + str(column_index)] = serializer.data[0]['processor_sh_proc']
                datas[20]['column' + str(column_index)] = serializer.data[0]['basic_intgr_bit']
                datas[21]['column' + str(column_index)] = serializer.data[0]['basic_intgr_add']
                datas[22]['column' + str(column_index)] = serializer.data[0]['basic_intgr_mul']
                datas[23]['column' + str(column_index)] = serializer.data[0]['basic_intgr_div']
                datas[24]['column' + str(column_index)] = serializer.data[0]['basic_intgr_mod']
                datas[25]['column' + str(column_index)] = serializer.data[0]['basic_int64_bit']
                datas[26]['column' + str(column_index)] = serializer.data[0]['basic_int64_add']
                datas[27]['column' + str(column_index)] = serializer.data[0]['basic_int64_mul']
                datas[28]['column' + str(column_index)] = serializer.data[0]['basic_int64_div']
                datas[29]['column' + str(column_index)] = serializer.data[0]['basic_int64_mod']
                datas[30]['column' + str(column_index)] = serializer.data[0]['basic_float_add']
                datas[31]['column' + str(column_index)] = serializer.data[0]['basic_float_mul']
                datas[32]['column' + str(column_index)] = serializer.data[0]['basic_float_div']
                datas[33]['column' + str(column_index)] = serializer.data[0]['basic_float_bogo']
                datas[34]['column' + str(column_index)] = serializer.data[0]['basic_double_add']
                datas[35]['column' + str(column_index)] = serializer.data[0]['basic_double_mul']
                datas[36]['column' + str(column_index)] = serializer.data[0]['basic_double_div']
                datas[37]['column' + str(column_index)] = serializer.data[0]['basic_double_bogo']
                datas[38]['column' + str(column_index)] = serializer.data[0]['context_2p_0K']
                datas[39]['column' + str(column_index)] = serializer.data[0]['context_2p_16K']
                datas[40]['column' + str(column_index)] = serializer.data[0]['context_2p_64K']
                datas[41]['column' + str(column_index)] = serializer.data[0]['context_8p_16K']
                datas[42]['column' + str(column_index)] = serializer.data[0]['context_8p_64K']
                datas[43]['column' + str(column_index)] = serializer.data[0]['context_16p_16K']
                datas[44]['column' + str(column_index)] = serializer.data[0]['context_16p_64K']
                datas[45]['column' + str(column_index)] = serializer.data[0]['local_2p_0K']
                ...
                datas[64]['column' + str(column_index)] = serializer.data[0]['local_bigger_File_reread']
                datas[65]['column' + str(column_index)] = serializer.data[0]['local_bigger_Mmap_reread']
                datas[66]['column' + str(column_index)] = serializer.data[0]['local_bigger_Bcopy_libc']
                datas[67]['column' + str(column_index)] = serializer.data[0]['local_bigger_Bcopy_hand']
                datas[68]['column' + str(column_index)] = serializer.data[0]['local_bigger_Mem_read']
                datas[69]['column' + str(column_index)] = serializer.data[0]['local_bigger_Mem_write']
                datas[70]['column' + str(column_index)] = serializer.data[0]['memory_Mhz']
                datas[71]['column' + str(column_index)] = serializer.data[0]['memory_L1']
                datas[72]['column' + str(column_index)] = serializer.data[0]['memory_L2']
                datas[73]['column' + str(column_index)] = serializer.data[0]['memory_Main_mem']
                datas[74]['column' + str(column_index)] = serializer.data[0]['memory_Rand_mem']
                title_index += 1
                column_index += 1
            ...
            for data in serializer_:
                ...
                datas[4]['column' + str(column_index)] = data.basic_Mhz
                datas[5]['column' + str(column_index)] = data.basic_tlb_pages
                datas[6]['column' + str(column_index)] = data.basic_cache_line_bytes
                datas[7]['column' + str(column_index)] = data.basic_mem_par
                datas[8]['column' + str(column_index)] = data.basic_scal_load
                datas[9]['column' + str(column_index)] = data.processor_Mhz
                datas[10]['column' + str(column_index)] = data.processor_null_call
                datas[11]['column' + str(column_index)] = data.processor_null_I_O
                datas[12]['column' + str(column_index)] = data.processor_stat
                datas[13]['column' + str(column_index)] = data.processor_open_close
                datas[14]['column' + str(column_index)] = data.processor_slct_TCP
                datas[15]['column' + str(column_index)] = data.processor_sig_inst
                datas[16]['column' + str(column_index)] = data.processor_sig_hndl
                datas[17]['column' + str(column_index)] = data.processor_fork_proc
                datas[18]['column' + str(column_index)] = data.processor_exec_proc
                datas[19]['column' + str(column_index)] = data.processor_sh_proc
                datas[20]['column' + str(column_index)] = data.basic_intgr_bit
                datas[21]['column' + str(column_index)] = data.basic_intgr_add
                datas[22]['column' + str(column_index)] = data.basic_intgr_mul
                datas[23]['column' + str(column_index)] = data.basic_intgr_div
                datas[24]['column' + str(column_index)] = data.basic_intgr_mod
                datas[25]['column' + str(column_index)] = data.basic_int64_bit
                datas[26]['column' + str(column_index)] = data.basic_int64_add
                datas[27]['column' + str(column_index)] = data.basic_int64_mul
                datas[28]['column' + str(column_index)] = data.basic_int64_div
                datas[29]['column' + str(column_index)] = data.basic_int64_mod
                datas[30]['column' + str(column_index)] = data.basic_float_add
                datas[31]['column' + str(column_index)] = data.basic_float_mul
                datas[32]['column' + str(column_index)] = data.basic_float_div
                datas[33]['column' + str(column_index)] = data.basic_float_bogo
                datas[34]['column' + str(column_index)] = data.basic_double_add
                datas[35]['column' + str(column_index)] = data.basic_double_mul
                datas[36]['column' + str(column_index)] = data.basic_double_div
                datas[37]['column' + str(column_index)] = data.basic_double_bogo
                datas[38]['column' + str(column_index)] = data.context_2p_0K
                datas[39]['column' + str(column_index)] = data.context_2p_16K
                datas[40]['column' + str(column_index)] = data.context_2p_64K
                datas[41]['column' + str(column_index)] = data.context_8p_16K
                datas[42]['column' + str(column_index)] = data.context_8p_64K
                datas[43]['column' + str(column_index)] = data.context_16p_16K
                datas[44]['column' + str(column_index)] = data.context_16p_64K
                datas[45]['column' + str(column_index)] = data.local_2p_0K
                ...
                datas[64]['column' + str(column_index)] = data.local_bigger_File_reread
                datas[65]['column' + str(column_index)] = data.local_bigger_Mmap_reread
                datas[66]['column' + str(column_index)] = data.local_bigger_Bcopy_libc
                datas[67]['column' + str(column_index)] = data.local_bigger_Bcopy_hand
                datas[68]['column' + str(column_index)] = data.local_bigger_Mem_read
                datas[69]['column' + str(column_index)] = data.local_bigger_Mem_write
                datas[70]['column' + str(column_index)] = data.memory_Mhz
                datas[71]['column' + str(column_index)] = data.memory_L1
                datas[72]['column' + str(column_index)] = data.memory_L2
                datas[73]['column' + str(column_index)] = data.memory_Main_mem
                datas[74]['column' + str(column_index)] = data.memory_Rand_mem
                column_index += 1
                title_index += 1
            title = '平均值(基准数据)' if not base_column_index else '平均值'
            # 基准数据和对比数据的平均数据
            ...
            datas[5]['column' + str(column_index)] = average_basic_tlb_pages
            datas[6]['column' + str(column_index)] = average_basic_cache_line_bytes
            datas[7]['column' + str(column_index)] = average_basic_mem_par
            datas[8]['column' + str(column_index)] = average_basic_scal_load
            datas[9]['column' + str(column_index)] = average_processor_Mhz
            datas[10]['column' + str(column_index)] = average_processor_null_call
            datas[11]['column' + str(column_index)] = average_processor_null_I_O
            datas[12]['column' + str(column_index)] = average_processor_stat
            datas[13]['column' + str(column_index)] = average_processor_open_close
            datas[14]['column' + str(column_index)] = average_processor_slct_TCP
            datas[15]['column' + str(column_index)] = average_processor_sig_inst
            datas[16]['column' + str(column_index)] = average_processor_sig_hndl
            datas[17]['column' + str(column_index)] = average_processor_fork_proc
            datas[18]['column' + str(column_index)] = average_processor_exec_proc
            datas[19]['column' + str(column_index)] = average_processor_sh_proc
            datas[20]['column' + str(column_index)] = average_basic_intgr_bit
            datas[21]['column' + str(column_index)] = average_basic_intgr_add
            datas[22]['column' + str(column_index)] = average_basic_intgr_mul
            datas[23]['column' + str(column_index)] = average_basic_intgr_div
            datas[24]['column' + str(column_index)] = average_basic_intgr_mod
            datas[25]['column' + str(column_index)] = average_basic_int64_bit
            datas[26]['column' + str(column_index)] = average_basic_int64_add
            datas[27]['column' + str(column_index)] = average_basic_int64_mul
            datas[28]['column' + str(column_index)] = average_basic_int64_div
            datas[29]['column' + str(column_index)] = average_basic_int64_mod
            datas[30]['column' + str(column_index)] = average_basic_float_add
            datas[31]['column' + str(column_index)] = average_basic_float_mul
            datas[32]['column' + str(column_index)] = average_basic_float_div
            datas[33]['column' + str(column_index)] = average_basic_float_bogo
            datas[34]['column' + str(column_index)] = average_basic_double_add
            datas[35]['column' + str(column_index)] = average_basic_double_mul
            datas[36]['column' + str(column_index)] = average_basic_double_div
            datas[37]['column' + str(column_index)] = average_basic_double_bogo
            datas[38]['column' + str(column_index)] = average_context_2p_0K
            datas[39]['column' + str(column_index)] = average_context_2p_16K
            datas[40]['column' + str(column_index)] = average_context_2p_64K
            datas[41]['column' + str(column_index)] = average_context_8p_16K
            datas[42]['column' + str(column_index)] = average_context_8p_64K
            datas[43]['column' + str(column_index)] = average_context_16p_16K
            datas[44]['column' + str(column_index)] = average_context_16p_64K
            datas[45]['column' + str(column_index)] = average_local_2p_0K
            datas[46]['column' + str(column_index)] = average_local_Pipe
            datas[47]['column' + str(column_index)] = average_local_AF_UNIX
            datas[48]['column' + str(column_index)] = average_local_UDP
            datas[49]['column' + str(column_index)] = average_local_RPC_UDP
            datas[50]['column' + str(column_index)] = average_local_TCP
            datas[51]['column' + str(column_index)] = average_local_RPC_TCP
            datas[52]['column' + str(column_index)] = average_local_TCP_conn
            datas[53]['column' + str(column_index)] = average_file_and_system_0K_File_create
            datas[54]['column' + str(column_index)] = average_file_and_system_0K_File_delete
            datas[55]['column' + str(column_index)] = average_file_and_system_10K_File_create
            datas[56]['column' + str(column_index)] = average_file_and_system_10K_File_delete
            datas[57]['column' + str(column_index)] = average_file_and_system_Mmap_Latency
            datas[58]['column' + str(column_index)] = average_file_and_system_Prot_Fault
            datas[59]['column' + str(column_index)] = average_file_and_system_Page_Fault
            datas[60]['column' + str(column_index)] = average_file_and_system_100fd_selct
            ...
            datas[64]['column' + str(column_index)] = average_local_bigger_File_reread
            datas[65]['column' + str(column_index)] = average_local_bigger_Mmap_reread
            datas[66]['column' + str(column_index)] = average_local_bigger_Bcopy_libc
            datas[67]['column' + str(column_index)] = average_local_bigger_Bcopy_hand
            datas[68]['column' + str(column_index)] = average_local_bigger_Mem_read
            datas[69]['column' + str(column_index)] = average_local_bigger_Mem_write
            datas[70]['column' + str(column_index)] = average_memory_Mhz
            datas[71]['column' + str(column_index)] = average_memory_L1
            datas[72]['column' + str(column_index)] = average_memory_L2
        ...
        for lmbench_json in request.__dict__['data_lmbench'][lmbench_keys]['items']:
            ...
            for key, value in new_lmbench.items():
                if key == "Basic system parameters":
                    ...
                    data_lmbench['processor_Mhz'] = value['Mhz']
                    data_lmbench['processor_null_call'] = value['null call']
                    data_lmbench['processor_null_I_O'] = value['null I/O']
                    data_lmbench['processor_stat'] = value['stat']
                    data_lmbench['processor_open_close'] = value['open close']
                    data_lmbench['processor_slct_TCP'] = value['slct TCP']
                    data_lmbench['processor_sig_inst'] = value['sig inst']
                    data_lmbench['processor_sig_hndl'] = value['sig hndl']
                    data_lmbench['processor_fork_proc'] = value['fork proc']
                    data_lmbench['processor_exec_proc'] = value['exec proc']
                    data_lmbench['processor_sh_proc'] = value['sh proc']
