    ...
    def get_data(self, serializer_, datas, title_index, column_index, base_average):
        ...
        if len(serializer_) == 1:
            ...
            if not base_average:
                ...
                datas[3]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_Mhz'] - base_average['basic_Mhz']) / base_average['basic_Mhz'] * 100) if serializer.data[0]['basic_Mhz'] is not None and base_average['basic_Mhz'] is not None else None
                datas[4]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_tlb_pages'] - base_average['basic_tlb_pages']) / base_average['basic_tlb_pages'] * 100) if serializer.data[0]['basic_tlb_pages'] is not None and base_average['basic_tlb_pages'] is not None else None
                datas[5]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_cache_line_bytes'] - base_average['basic_cache_line_bytes']) / base_average['basic_cache_line_bytes'] * 100) if serializer.data[0]['basic_cache_line_bytes'] is not None and base_average['basic_cache_line_bytes'] is not None else None
                datas[6]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_mem_par'] - base_average['basic_mem_par']) / base_average['basic_mem_par'] * 100) if serializer.data[0]['basic_mem_par'] is not None and base_average['basic_mem_par'] is not None else None
                datas[7]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_scal_load'] - base_average['basic_scal_load']) / base_average['basic_scal_load'] * 100) if serializer.data[0]['basic_scal_load'] is not None and base_average['basic_scal_load'] is not None else None
                datas[8]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['processor_null_call'] - base_average['processor_null_call']) / base_average['processor_null_call'] * 100) if serializer.data[0]['processor_null_call'] is not None and base_average['processor_null_call'] is not None else None
                datas[9]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['processor_null_I_O'] - base_average['processor_null_I_O']) / base_average['processor_null_I_O'] * 100) if serializer.data[0]['processor_null_I_O'] is not None and base_average['processor_null_I_O'] is not None else None
                datas[10]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['processor_stat'] - base_average['processor_stat']) / base_average['processor_stat'] * 100) if serializer.data[0]['processor_stat'] is not None and base_average['processor_stat'] is not None else None
                datas[11]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['processor_open_clo'] - base_average['processor_open_clo']) / base_average['processor_open_clo'] * 100) if serializer.data[0]['processor_open_clo'] is not None and base_average['processor_open_clo'] is not None else None
                datas[12]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['processor_slct_TCP'] - base_average['processor_slct_TCP']) / base_average['processor_slct_TCP'] * 100) if serializer.data[0]['processor_slct_TCP'] is not None and base_average['processor_slct_TCP'] is not None else None
                datas[13]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['processor_sig_inst'] - base_average['processor_sig_inst']) / base_average['processor_sig_inst'] * 100) if serializer.data[0]['processor_sig_inst'] is not None and base_average['processor_sig_inst'] is not None else None
                datas[14]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['processor_sig_hndl'] - base_average['processor_sig_hndl']) / base_average['processor_sig_hndl'] * 100) if serializer.data[0]['processor_sig_hndl'] is not None and base_average['processor_sig_hndl'] is not None else None
                datas[15]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['processor_fork_proc'] - base_average['processor_fork_proc']) / base_average['processor_fork_proc'] * 100) if serializer.data[0]['processor_fork_proc'] is not None and base_average['processor_fork_proc'] is not None else None
                datas[16]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['processor_exec_proc'] - base_average['processor_exec_proc']) / base_average['processor_exec_proc'] * 100) if serializer.data[0]['processor_exec_proc'] is not None and base_average['processor_exec_proc'] is not None else None
                datas[17]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['processor_sh_proc'] - base_average['processor_sh_proc']) / base_average['processor_sh_proc'] * 100) if serializer.data[0]['processor_sh_proc'] is not None and base_average['processor_sh_proc'] is not None else None
                datas[18]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['processor_Mhz'] - base_average['processor_Mhz']) / base_average['processor_Mhz'] * 100) if serializer.data[0]['processor_Mhz'] is not None and base_average['processor_Mhz'] is not None else None
                datas[19]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_intgr_bit'] - base_average['basic_intgr_bit']) / base_average['basic_intgr_bit'] * 100) if serializer.data[0]['basic_intgr_bit'] is not None and base_average['basic_intgr_bit'] is not None else None
                datas[20]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_intgr_add'] - base_average['basic_intgr_add']) / base_average['basic_intgr_add'] * 100) if serializer.data[0]['basic_intgr_add'] is not None and base_average['basic_intgr_add'] is not None else None
                datas[21]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_intgr_mul'] - base_average['basic_intgr_mul']) / base_average['basic_intgr_mul'] * 100) if serializer.data[0]['basic_intgr_mul'] is not None and base_average['basic_intgr_mul'] is not None else None
                datas[22]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_intgr_div'] - base_average['basic_intgr_div']) / base_average['basic_intgr_div'] * 100) if serializer.data[0]['basic_intgr_div'] is not None and base_average['basic_intgr_div'] is not None else None
                datas[23]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_intgr_mod'] - base_average['basic_intgr_mod']) / base_average['basic_intgr_mod'] * 100) if serializer.data[0]['basic_intgr_mod'] is not None and base_average['basic_intgr_mod'] is not None else None
                datas[24]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_int64_bit'] - base_average['basic_int64_bit']) / base_average['basic_int64_bit'] * 100) if serializer.data[0]['basic_int64_bit'] is not None and base_average['basic_int64_bit'] is not None else None
                datas[25]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_int64_add'] - base_average['basic_int64_add']) / base_average['basic_int64_add'] * 100) if serializer.data[0]['basic_int64_add'] is not None and base_average['basic_int64_add'] is not None else None
                datas[26]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_int64_mul'] - base_average['basic_int64_mul']) / base_average['basic_int64_mul'] * 100) if serializer.data[0]['basic_int64_mul'] is not None and base_average['basic_int64_mul'] is not None else None
                datas[27]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_int64_div'] - base_average['basic_int64_div']) / base_average['basic_int64_div'] * 100) if serializer.data[0]['basic_int64_div'] is not None and base_average['basic_int64_div'] is not None else None
                datas[28]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_int64_mod'] - base_average['basic_int64_mod']) / base_average['basic_int64_mod'] * 100) if serializer.data[0]['basic_int64_mod'] is not None and base_average['basic_int64_mod'] is not None else None
                datas[29]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_float_add'] - base_average['basic_float_add']) / base_average['basic_float_add'] * 100) if serializer.data[0]['basic_float_add'] is not None and base_average['basic_float_add'] is not None else None
                datas[30]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_float_mul'] - base_average['basic_float_mul']) / base_average['basic_float_mul'] * 100) if serializer.data[0]['basic_float_mul'] is not None and base_average['basic_float_mul'] is not None else None
                datas[31]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_float_div'] - base_average['basic_float_div']) / base_average['basic_float_div'] * 100) if serializer.data[0]['basic_float_div'] is not None and base_average['basic_float_div'] is not None else None
                datas[32]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_float_bogo'] - base_average['basic_float_bogo']) / base_average['basic_float_bogo'] * 100) if serializer.data[0]['basic_float_bogo'] is not None and base_average['basic_float_bogo'] is not None else None
                datas[33]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_double_add'] - base_average['basic_double_add']) / base_average['basic_double_add'] * 100) if serializer.data[0]['basic_double_add'] is not None and base_average['basic_double_add'] is not None else None
                datas[34]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_double_mul'] - base_average['basic_double_mul']) / base_average['basic_double_mul'] * 100) if serializer.data[0]['basic_double_mul'] is not None and base_average['basic_double_mul'] is not None else None
                datas[35]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_double_div'] - base_average['basic_double_div']) / base_average['basic_double_div'] * 100) if serializer.data[0]['basic_double_div'] is not None and base_average['basic_double_div'] is not None else None
                datas[36]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['basic_double_bogo'] - base_average['basic_double_bogo']) / base_average['basic_double_bogo'] * 100) if serializer.data[0]['basic_double_bogo'] is not None and base_average['basic_double_bogo'] is not None else None
                datas[37]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['context_2p_0K'] - base_average['context_2p_0K']) / base_average['context_2p_0K'] * 100) if serializer.data[0]['context_2p_0K'] is not None and base_average['context_2p_0K'] is not None else None
                datas[38]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['context_2p_16K'] - base_average['context_2p_16K']) / base_average['context_2p_16K'] * 100) if serializer.data[0]['context_2p_16K'] is not None and base_average['context_2p_16K'] is not None else None
                datas[39]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['context_2p_64K'] - base_average['context_2p_64K']) / base_average['context_2p_64K'] * 100) if serializer.data[0]['context_2p_64K'] is not None and base_average['context_2p_64K'] is not None else None
                datas[40]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['context_8p_16K'] - base_average['context_8p_16K']) / base_average['context_8p_16K'] * 100) if serializer.data[0]['context_8p_16K'] is not None and base_average['context_8p_16K'] is not None else None
                datas[41]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['context_8p_64K'] - base_average['context_8p_64K']) / base_average['context_8p_64K'] * 100) if serializer.data[0]['context_8p_64K'] is not None and base_average['context_8p_64K'] is not None else None
                datas[42]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['context_16p_16K'] - base_average['context_16p_16K']) / base_average['context_16p_16K'] * 100) if serializer.data[0]['context_16p_16K'] is not None and base_average['context_16p_16K'] is not None else None
                datas[43]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['context_16p_64K'] - base_average['context_16p_64K']) / base_average['context_16p_64K'] * 100) if serializer.data[0]['context_16p_64K'] is not None and base_average['context_16p_64K'] is not None else None
                datas[44]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_2p_0K'] - base_average['local_2p_0K']) / base_average['local_2p_0K'] * 100) if serializer.data[0]['local_2p_0K'] is not None and base_average['local_2p_0K'] is not None else None
                datas[45]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_Pipe'] - base_average['local_Pipe']) / base_average['local_Pipe'] * 100) if serializer.data[0]['local_Pipe'] is not None and base_average['local_Pipe'] is not None else None
                datas[46]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_AF_UNIX'] - base_average['local_AF_UNIX']) / base_average['local_AF_UNIX'] * 100) if serializer.data[0]['local_AF_UNIX'] is not None and base_average['local_AF_UNIX'] is not None else None
                datas[47]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_UDP'] - base_average['local_UDP']) / base_average['local_UDP'] * 100) if serializer.data[0]['local_UDP'] is not None and base_average['local_UDP'] is not None else None
                datas[48]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_TCP'] - base_average['local_TCP']) / base_average['local_TCP'] * 100) if serializer.data[0]['local_TCP'] is not None and base_average['local_TCP'] is not None else None
                datas[49]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_TCP_conn'] - base_average['local_TCP_conn']) / base_average['local_TCP_conn'] * 100) if serializer.data[0]['local_TCP_conn'] is not None and base_average['local_TCP_conn'] is not None else None
                datas[50]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_RPC_TCP'] - base_average['local_RPC_TCP']) / base_average['local_RPC_TCP'] * 100) if serializer.data[0]['local_RPC_TCP'] is not None and base_average['local_RPC_TCP'] is not None else None
                datas[51]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_RPC_UDP'] - base_average['local_RPC_UDP']) / base_average['local_RPC_UDP'] * 100) if serializer.data[0]['local_RPC_UDP'] is not None and base_average['local_RPC_UDP'] is not None else None
                datas[52]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_Mmap_Latency'] - base_average['local_bigger_Mmap_Latency']) / base_average['local_bigger_Mmap_Latency'] * 100) if serializer.data[0]['local_bigger_Mmap_Latency'] is not None and base_average['local_bigger_Mmap_Latency'] is not None else None
                datas[53]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_Prot_Fault'] - base_average['local_bigger_Prot_Fault']) / base_average['local_bigger_Prot_Fault'] * 100) if serializer.data[0]['local_bigger_Prot_Fault'] is not None and base_average['local_bigger_Prot_Fault'] is not None else None
                datas[54]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_Page_Fault'] - base_average['local_bigger_Page_Fault']) / base_average['local_bigger_Page_Fault'] * 100) if serializer.data[0]['local_bigger_Page_Fault'] is not None and base_average['local_bigger_Page_Fault'] is not None else None
                datas[55]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_100fd_selct'] - base_average['local_bigger_100fd_selct']) / base_average['local_bigger_100fd_selct'] * 100) if serializer.data[0]['local_bigger_100fd_selct'] is not None and base_average['local_bigger_100fd_selct'] is not None else None
                datas[56]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_0K_File_create'] - base_average['local_bigger_0K_File_create']) / base_average['local_bigger_0K_File_create'] * 100) if serializer.data[0]['local_bigger_0K_File_create'] is not None and base_average['local_bigger_0K_File_create'] is not None else None
                datas[57]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_0K_File_delete'] - base_average['local_bigger_0K_File_delete']) / base_average['local_bigger_0K_File_delete'] * 100) if serializer.data[0]['local_bigger_0K_File_delete'] is not None and base_average['local_bigger_0K_File_delete'] is not None else None
                datas[58]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_10K_File_create'] - base_average['local_bigger_10K_File_create']) / base_average['local_bigger_10K_File_create'] * 100) if serializer.data[0]['local_bigger_10K_File_create'] is not None and base_average['local_bigger_10K_File_create'] is not None else None
                datas[59]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_10K_File_delete'] - base_average['local_bigger_10K_File_delete']) / base_average['local_bigger_10K_File_delete'] * 100) if serializer.data[0]['local_bigger_10K_File_delete'] is not None and base_average['local_bigger_10K_File_delete'] is not None else None
                datas[60]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_Pipe'] - base_average['local_bigger_Pipe']) / base_average['local_bigger_Pipe'] * 100) if serializer.data[0]['local_bigger_Pipe'] is not None and base_average['local_bigger_Pipe'] is not None else None
                datas[61]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_AF_UNIX'] - base_average['local_bigger_AF_UNIX']) / base_average['local_bigger_AF_UNIX'] * 100) if serializer.data[0]['local_bigger_AF_UNIX'] is not None and base_average['local_bigger_AF_UNIX'] is not None else None
                datas[62]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_TCP'] - base_average['local_bigger_TCP']) / base_average['local_bigger_TCP'] * 100) if serializer.data[0]['local_bigger_TCP'] is not None and base_average['local_bigger_TCP'] is not None else None
                datas[63]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_File_reread'] - base_average['local_bigger_File_reread']) / base_average['local_bigger_File_reread'] * 100) if serializer.data[0]['local_bigger_File_reread'] is not None and base_average['local_bigger_File_reread'] is not None else None
                datas[64]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_Mmap_reread'] - base_average['local_bigger_Mmap_reread']) / base_average['local_bigger_Mmap_reread'] * 100) if serializer.data[0]['local_bigger_Mmap_reread'] is not None and base_average['local_bigger_Mmap_reread'] is not None else None
                datas[65]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_Bcopy_libc'] - base_average['local_bigger_Bcopy_libc']) / base_average['local_bigger_Bcopy_libc'] * 100) if serializer.data[0]['local_bigger_Bcopy_libc'] is not None and base_average['local_bigger_Bcopy_libc'] is not None else None
                datas[66]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_Bcopy_hand'] - base_average['local_bigger_Bcopy_hand']) / base_average['local_bigger_Bcopy_hand'] * 100) if serializer.data[0]['local_bigger_Bcopy_hand'] is not None and base_average['local_bigger_Bcopy_hand'] is not None else None
                datas[67]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_Mem_read'] - base_average['local_bigger_Mem_read']) / base_average['local_bigger_Mem_read'] * 100) if serializer.data[0]['local_bigger_Mem_read'] is not None and base_average['local_bigger_Mem_read'] is not None else None
                datas[68]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['local_bigger_Mem_write'] - base_average['local_bigger_Mem_write']) / base_average['local_bigger_Mem_write'] * 100) if serializer.data[0]['local_bigger_Mem_write'] is not None and base_average['local_bigger_Mem_write'] is not None else None
                datas[69]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['memory_Mhz'] - base_average['memory_Mhz']) / base_average['memory_Mhz'] * 100) if serializer.data[0]['memory_Mhz'] is not None and base_average['memory_Mhz'] is not None else None
                datas[70]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['memory_L1'] - base_average['memory_L1']) / base_average['memory_L1'] * 100) if serializer.data[0]['memory_L1'] is not None and base_average['memory_L1'] is not None else None
                datas[71]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['memory_L2'] - base_average['memory_L2']) / base_average['memory_L2'] * 100) if serializer.data[0]['memory_L2'] is not None and base_average['memory_L2'] is not None else None
                datas[72]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['memory_Main_mem'] - base_average['memory_Main_mem']) / base_average['memory_Main_mem'] * 100) if serializer.data[0]['memory_Main_mem'] is not None and base_average['memory_Main_mem'] is not None else None
                datas[73]['column' + str(column_index)] = "%.2f%%" % ((serializer.data[0]['memory_Rand_mem'] - base_average['memory_Rand_mem']) / base_average['memory_Rand_mem'] * 100) if serializer.data[0]['memory_Rand_mem'] is not None and base_average['memory_Rand_mem'] is not None else None
                column_index += 1
        else:
            # 计算平均值
            ...
            if not base_average:
                ...
                datas[1]['column' + str(column_index)] = ''
                datas[2]['column' + str(column_index)] = ''
                datas[3]['column' + str(column_index)] = "%.2f%%" % ((average_basic_Mhz - base_average['basic_Mhz']) / base_average['basic_Mhz'] * 100) if average_basic_Mhz is not None and base_average['basic_Mhz'] is not None else None
                datas[4]['column' + str(column_index)] = "%.2f%%" % ((average_basic_tlb_pages - base_average['basic_tlb_pages']) / base_average['basic_tlb_pages'] * 100) if average_basic_tlb_pages is not None and base_average['basic_tlb_pages'] is not None else None
                datas[5]['column' + str(column_index)] = "%.2f%%" % ((average_basic_cache_line_bytes - base_average['basic_cache_line_bytes']) / base_average['basic_cache_line_bytes'] * 100) if average_basic_cache_line_bytes is not None and base_average['basic_cache_line_bytes'] is not None else None
                datas[6]['column' + str(column_index)] = "%.2f%%" % ((average_basic_mem_par - base_average['basic_mem_par']) / base_average['basic_mem_par'] * 100) if average_basic_mem_par is not None and base_average['basic_mem_par'] is not None else None
                datas[7]['column' + str(column_index)] = "%.2f%%" % ((average_basic_scal_load - base_average['basic_scal_load']) / base_average['basic_scal_load'] * 100) if average_basic_scal_load is not None and base_average['basic_scal_load'] is not None else None
                datas[8]['column' + str(column_index)] = "%.2f%%" % ((average_processor_null_call - base_average['processor_null_call']) / base_average['processor_null_call'] * 100) if average_processor_null_call is not None and base_average['processor_null_call'] is not None else None
                datas[9]['column' + str(column_index)] = "%.2f%%" % ((average_processor_null_I_O - base_average['processor_null_I_O']) / base_average['processor_null_I_O'] * 100) if average_processor_null_I_O is not None and base_average['processor_null_I_O'] is not None else None
                datas[10]['column' + str(column_index)] = "%.2f%%" % ((average_processor_stat - base_average['processor_stat']) / base_average['processor_stat'] * 100) if average_processor_stat is not None and base_average['processor_stat'] is not None else None
                datas[11]['column' + str(column_index)] = "%.2f%%" % ((average_processor_open_clo - base_average['processor_open_clo']) / base_average['processor_open_clo'] * 100) if average_processor_open_clo is not None and base_average['processor_open_clo'] is not None else None
                datas[12]['column' + str(column_index)] = "%.2f%%" % ((average_processor_slct_TCP - base_average['processor_slct_TCP']) / base_average['processor_slct_TCP'] * 100) if average_processor_slct_TCP is not None and base_average['processor_slct_TCP'] is not None else None
                datas[13]['column' + str(column_index)] = "%.2f%%" % ((average_processor_sig_inst - base_average['processor_sig_inst']) / base_average['processor_sig_inst'] * 100) if average_processor_sig_inst is not None and base_average['processor_sig_inst'] is not None else None
                datas[14]['column' + str(column_index)] = "%.2f%%" % ((average_processor_sig_hndl - base_average['processor_sig_hndl']) / base_average['processor_sig_hndl'] * 100) if average_processor_sig_hndl is not None and base_average['processor_sig_hndl'] is not None else None
                datas[15]['column' + str(column_index)] = "%.2f%%" % ((average_processor_fork_proc - base_average['processor_fork_proc']) / base_average['processor_fork_proc'] * 100) if average_processor_fork_proc is not None and base_average['processor_fork_proc'] is not None else None
                datas[16]['column' + str(column_index)] = "%.2f%%" % ((average_processor_exec_proc - base_average['processor_exec_proc']) / base_average['processor_exec_proc'] * 100) if average_processor_exec_proc is not None and base_average['processor_exec_proc'] is not None else None
                datas[17]['column' + str(column_index)] = "%.2f%%" % ((average_processor_sh_proc - base_average['processor_sh_proc']) / base_average['processor_sh_proc'] * 100) if average_processor_sh_proc is not None and base_average['processor_sh_proc'] is not None else None
                datas[18]['column' + str(column_index)] = "%.2f%%" % ((average_processor_Mhz - base_average['processor_Mhz']) / base_average['processor_Mhz'] * 100) if average_processor_Mhz is not None and base_average['processor_Mhz'] is not None else None
                datas[19]['column' + str(column_index)] = "%.2f%%" % ((average_basic_intgr_bit - base_average['basic_intgr_bit']) / base_average['basic_intgr_bit'] * 100) if average_basic_intgr_bit is not None and base_average['basic_intgr_bit'] is not None else None
                datas[20]['column' + str(column_index)] = "%.2f%%" % ((average_basic_intgr_add - base_average['basic_intgr_add']) / base_average['basic_intgr_add'] * 100) if average_basic_intgr_add is not None and base_average['basic_intgr_add'] is not None else None
                datas[21]['column' + str(column_index)] = "%.2f%%" % ((average_basic_intgr_mul - base_average['basic_intgr_mul']) / base_average['basic_intgr_mul'] * 100) if average_basic_intgr_mul is not None and base_average['basic_intgr_mul'] is not None else None
                datas[22]['column' + str(column_index)] = "%.2f%%" % ((average_basic_intgr_div - base_average['basic_intgr_div']) / base_average['basic_intgr_div'] * 100) if average_basic_intgr_div is not None and base_average['basic_intgr_div'] is not None else None
                datas[23]['column' + str(column_index)] = "%.2f%%" % ((average_basic_intgr_mod - base_average['basic_intgr_mod']) / base_average['basic_intgr_mod'] * 100) if average_basic_intgr_mod is not None and base_average['basic_intgr_mod'] is not None else None
                datas[24]['column' + str(column_index)] = "%.2f%%" % ((average_basic_int64_bit - base_average['basic_int64_bit']) / base_average['basic_int64_bit'] * 100) if average_basic_int64_bit is not None and base_average['basic_int64_bit'] is not None else None
                datas[25]['column' + str(column_index)] = "%.2f%%" % ((average_basic_int64_add - base_average['basic_int64_add']) / base_average['basic_int64_add'] * 100) if average_basic_int64_add is not None and base_average['basic_int64_add'] is not None else None
                datas[26]['column' + str(column_index)] = "%.2f%%" % ((average_basic_int64_mul - base_average['basic_int64_mul']) / base_average['basic_int64_mul'] * 100) if average_basic_int64_mul is not None and base_average['basic_int64_mul'] is not None else None
                datas[27]['column' + str(column_index)] = "%.2f%%" % ((average_basic_int64_div - base_average['basic_int64_div']) / base_average['basic_int64_div'] * 100) if average_basic_int64_div is not None and base_average['basic_int64_div'] is not None else None
                datas[28]['column' + str(column_index)] = "%.2f%%" % ((average_basic_int64_mod - base_average['basic_int64_mod']) / base_average['basic_int64_mod'] * 100) if average_basic_int64_mod is not None and base_average['basic_int64_mod'] is not None else None
                datas[29]['column' + str(column_index)] = "%.2f%%" % ((average_basic_float_add - base_average['basic_float_add']) / base_average['basic_float_add'] * 100) if average_basic_float_add is not None and base_average['basic_float_add'] is not None else None
                datas[30]['column' + str(column_index)] = "%.2f%%" % ((average_basic_float_mul - base_average['basic_float_mul']) / base_average['basic_float_mul'] * 100) if average_basic_float_mul is not None and base_average['basic_float_mul'] is not None else None
                datas[31]['column' + str(column_index)] = "%.2f%%" % ((average_basic_float_div - base_average['basic_float_div']) / base_average['basic_float_div'] * 100) if average_basic_float_div is not None and base_average['basic_float_div'] is not None else None
                datas[32]['column' + str(column_index)] = "%.2f%%" % ((average_basic_float_bogo - base_average['basic_float_bogo']) / base_average['basic_float_bogo'] * 100) if average_basic_float_bogo is not None and base_average['basic_float_bogo'] is not None else None
                datas[33]['column' + str(column_index)] = "%.2f%%" % ((average_basic_double_add - base_average['basic_double_add']) / base_average['basic_double_add'] * 100) if average_basic_double_add is not None and base_average['basic_double_add'] is not None else None
                datas[34]['column' + str(column_index)] = "%.2f%%" % ((average_basic_double_mul - base_average['basic_double_mul']) / base_average['basic_double_mul'] * 100) if average_basic_double_mul is not None and base_average['basic_double_mul'] is not None else None
                datas[35]['column' + str(column_index)] = "%.2f%%" % ((average_basic_double_div - base_average['basic_double_div']) / base_average['basic_double_div'] * 100) if average_basic_double_div is not None and base_average['basic_double_div'] is not None else None
                datas[36]['column' + str(column_index)] = "%.2f%%" % ((average_basic_double_bogo - base_average['basic_double_bogo']) / base_average['basic_double_bogo'] * 100) if average_basic_double_bogo is not None and base_average['basic_double_bogo'] is not None else None
                datas[37]['column' + str(column_index)] = "%.2f%%" % ((average_context_2p_0K - base_average['context_2p_0K']) / base_average['context_2p_0K'] * 100) if average_context_2p_0K is not None and base_average['context_2p_0K'] is not None else None
                datas[38]['column' + str(column_index)] = "%.2f%%" % ((average_context_2p_16K - base_average['context_2p_16K']) / base_average['context_2p_16K'] * 100) if average_context_2p_16K is not None and base_average['context_2p_16K'] is not None else None
                datas[39]['column' + str(column_index)] = "%.2f%%" % ((average_context_2p_64K - base_average['context_2p_64K']) / base_average['context_2p_64K'] * 100) if average_context_2p_64K is not None and base_average['context_2p_64K'] is not None else None
                datas[40]['column' + str(column_index)] = "%.2f%%" % ((average_context_8p_16K - base_average['context_8p_16K']) / base_average['context_8p_16K'] * 100) if average_context_8p_16K is not None and base_average['context_8p_16K'] is not None else None
                datas[41]['column' + str(column_index)] = "%.2f%%" % ((average_context_8p_64K - base_average['context_8p_64K']) / base_average['context_8p_64K'] * 100) if average_context_8p_64K is not None and base_average['context_8p_64K'] is not None else None
                datas[42]['column' + str(column_index)] = "%.2f%%" % ((average_context_16p_16K - base_average['context_16p_16K']) / base_average['context_16p_16K'] * 100) if average_context_16p_16K is not None and base_average['context_16p_16K'] is not None else None
                datas[43]['column' + str(column_index)] = "%.2f%%" % ((average_context_16p_64K - base_average['context_16p_64K']) / base_average['context_16p_64K'] * 100) if average_context_16p_64K is not None and base_average['context_16p_64K'] is not None else None
                datas[44]['column' + str(column_index)] = "%.2f%%" % ((average_local_2p_0K - base_average['local_2p_0K']) / base_average['local_2p_0K'] * 100) if average_local_2p_0K is not None and base_average['local_2p_0K'] is not None else None
                datas[45]['column' + str(column_index)] = "%.2f%%" % ((average_local_Pipe - base_average['local_Pipe']) / base_average['local_Pipe'] * 100) if average_local_Pipe is not None and base_average['local_Pipe'] is not None else None
                datas[46]['column' + str(column_index)] = "%.2f%%" % ((average_local_AF_UNIX - base_average['local_AF_UNIX']) / base_average['local_AF_UNIX'] * 100) if average_local_AF_UNIX is not None and base_average['local_AF_UNIX'] is not None else None
                datas[47]['column' + str(column_index)] = "%.2f%%" % ((average_local_UDP - base_average['local_UDP']) / base_average['local_UDP'] * 100) if average_local_UDP is not None and base_average['local_UDP'] is not None else None
                datas[48]['column' + str(column_index)] = "%.2f%%" % ((average_local_TCP - base_average['local_TCP']) / base_average['local_TCP'] * 100) if average_local_TCP is not None and base_average['local_TCP'] is not None else None
                datas[49]['column' + str(column_index)] = "%.2f%%" % ((average_local_TCP_conn - base_average['local_TCP_conn']) / base_average['local_TCP_conn'] * 100) if average_local_TCP_conn is not None and base_average['local_TCP_conn'] is not None else None
                datas[50]['column' + str(column_index)] = "%.2f%%" % ((average_local_RPC_TCP - base_average['local_RPC_TCP']) / base_average['local_RPC_TCP'] * 100) if average_local_RPC_TCP is not None and base_average['local_RPC_TCP'] is not None else None
                datas[51]['column' + str(column_index)] = "%.2f%%" % ((average_local_RPC_UDP - base_average['local_RPC_UDP']) / base_average['local_RPC_UDP'] * 100) if average_local_RPC_UDP is not None and base_average['local_RPC_UDP'] is not None else None
                datas[52]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_Mmap_Latency - base_average['local_bigger_Mmap_Latency']) / base_average['local_bigger_Mmap_Latency'] * 100) if average_local_bigger_Mmap_Latency is not None and base_average['local_bigger_Mmap_Latency'] is not None else None
                datas[53]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_Prot_Fault - base_average['local_bigger_Prot_Fault']) / base_average['local_bigger_Prot_Fault'] * 100) if average_local_bigger_Prot_Fault is not None and base_average['local_bigger_Prot_Fault'] is not None else None
                datas[54]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_Page_Fault - base_average['local_bigger_Page_Fault']) / base_average['local_bigger_Page_Fault'] * 100) if average_local_bigger_Page_Fault is not None and base_average['local_bigger_Page_Fault'] is not None else None
                datas[55]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_100fd_selct - base_average['local_bigger_100fd_selct']) / base_average['local_bigger_100fd_selct'] * 100) if average_local_bigger_100fd_selct is not None and base_average['local_bigger_100fd_selct'] is not None else None
                datas[56]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_0K_File_create - base_average['local_bigger_0K_File_create']) / base_average['local_bigger_0K_File_create'] * 100) if average_local_bigger_0K_File_create is not None and base_average['local_bigger_0K_File_create'] is not None else None
                datas[57]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_0K_File_delete - base_average['local_bigger_0K_File_delete']) / base_average['local_bigger_0K_File_delete'] * 100) if average_local_bigger_0K_File_delete is not None and base_average['local_bigger_0K_File_delete'] is not None else None
                datas[58]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_10K_File_create - base_average['local_bigger_10K_File_create']) / base_average['local_bigger_10K_File_create'] * 100) if average_local_bigger_10K_File_create is not None and base_average['local_bigger_10K_File_create'] is not None else None
                datas[59]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_10K_File_delete - base_average['local_bigger_10K_File_delete']) / base_average['local_bigger_10K_File_delete'] * 100) if average_local_bigger_10K_File_delete is not None and base_average['local_bigger_10K_File_delete'] is not None else None
                datas[60]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_Pipe - base_average['local_bigger_Pipe']) / base_average['local_bigger_Pipe'] * 100) if average_local_bigger_Pipe is not None and base_average['local_bigger_Pipe'] is not None else None
                datas[61]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_AF_UNIX - base_average['local_bigger_AF_UNIX']) / base_average['local_bigger_AF_UNIX'] * 100) if average_local_bigger_AF_UNIX is not None and base_average['local_bigger_AF_UNIX'] is not None else None
                datas[62]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_TCP - base_average['local_bigger_TCP']) / base_average['local_bigger_TCP'] * 100) if average_local_bigger_TCP is not None and base_average['local_bigger_TCP'] is not None else None
                datas[63]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_File_reread - base_average['local_bigger_File_reread']) / base_average['local_bigger_File_reread'] * 100) if average_local_bigger_File_reread is not None and base_average['local_bigger_File_reread'] is not None else None
                datas[64]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_Mmap_reread - base_average['local_bigger_Mmap_reread']) / base_average['local_bigger_Mmap_reread'] * 100) if average_local_bigger_Mmap_reread is not None and base_average['local_bigger_Mmap_reread'] is not None else None
                datas[65]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_Bcopy_libc - base_average['local_bigger_Bcopy_libc']) / base_average['local_bigger_Bcopy_libc'] * 100) if average_local_bigger_Bcopy_libc is not None and base_average['local_bigger_Bcopy_libc'] is not None else None
                datas[66]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_Bcopy_hand - base_average['local_bigger_Bcopy_hand']) / base_average['local_bigger_Bcopy_hand'] * 100) if average_local_bigger_Bcopy_hand is not None and base_average['local_bigger_Bcopy_hand'] is not None else None
                datas[67]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_Mem_read - base_average['local_bigger_Mem_read']) / base_average['local_bigger_Mem_read'] * 100) if average_local_bigger_Mem_read is not None and base_average['local_bigger_Mem_read'] is not None else None
                datas[68]['column' + str(column_index)] = "%.2f%%" % ((average_local_bigger_Mem_write - base_average['local_bigger_Mem_write']) / base_average['local_bigger_Mem_write'] * 100) if average_local_bigger_Mem_write is not None and base_average['local_bigger_Mem_write'] is not None else None
                datas[69]['column' + str(column_index)] = "%.2f%%" % ((average_memory_Mhz - base_average['memory_Mhz']) / base_average['memory_Mhz'] * 100) if average_memory_Mhz is not None and base_average['memory_Mhz'] is not None else None
                datas[70]['column' + str(column_index)] = "%.2f%%" % ((average_memory_L1 - base_average['memory_L1']) / base_average['memory_L1'] * 100) if average_memory_L1 is not None and base_average['memory_L1'] is not None else None
                datas[71]['column' + str(column_index)] = "%.2f%%" % ((average_memory_L2 - base_average['memory_L2']) / base_average['memory_L2'] * 100) if average_memory_L2 is not None and base_average['memory_L2'] is not None else None
                datas[72]['column' + str(column_index)] = "%.2f%%" % ((average_memory_Main_mem - base_average['memory_Main_mem']) / base_average['memory_Main_mem'] * 100) if average_memory_Main_mem is not None and base_average['memory_Main_mem'] is not None else None
                datas[73]['column' + str(column_index)] = "%.2f%%" % ((average_memory_Rand_mem - base_average['memory_Rand_mem']) / base_average['memory_Rand_mem'] * 100) if average_memory_Rand_mem is not None and base_average['memory_Rand_mem'] is not None else None
                column_index += 1
