...
class Lmbench(models.Model):
    ...
    file_and_system_0K_File_create = models.FloatField(verbose_name="File & VM system latencies in microseconds, 0K File create", null=True, blank=True)
    file_and_system_0K_File_delete = models.FloatField(verbose_name="File & VM system latencies in microseconds, 0K File delete", null=True, blank=True)
    file_and_system_10K_File_create = models.FloatField(verbose_name="File & VM system latencies in microseconds, 10K File create", null=True, blank=True)
    file_and_system_10K_File_delete = models.FloatField(verbose_name="File & VM system latencies in microseconds, 10K File delete", null=True, blank=True)
    file_and_system_Mmap_Latency = models.FloatField(verbose_name="File & VM system latencies in microseconds, Mmap Latency", null=True, blank=True)
    file_and_system_Prot_Fault = models.FloatField(verbose_name="File & VM system latencies in microseconds, Prot Fault", null=True, blank=True)
    file_and_system_Page_Fault = models.FloatField(verbose_name="File & VM system latencies in microseconds, Page Fault", null=True, blank=True)
    file_and_system_100fd_selct = models.FloatField(verbose_name="File & VM system latencies in microseconds, 100fd selct", null=True, blank=True)
