...
class Lmbench(models.Model):
    ...
    processor_open_close = models.FloatField(verbose_name="Processor, open clo",null=True,blank=True)
    ...
    local_bigger_0K_File_create = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), 0K File create",null=True,blank=True)
    local_bigger_0K_File_delete = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), 0K File delete",null=True,blank=True)
    local_bigger_10K_File_create = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), 10K File create",null=True,blank=True)
    local_bigger_10K_File_delete = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), 10K File delete",null=True,blank=True)
    local_bigger_Mmap_Latency = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), Mmap Latency",null=True,blank=True)
    local_bigger_Prot_Fault = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), Prot Fault",null=True,blank=True)
    local_bigger_Page_Fault = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), Page Fault",null=True,blank=True)
    local_bigger_100fd_selct = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), 100fd selct",null=True,blank=True)
    local_bigger_Pipe = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), Pipe",null=True,blank=True)
    local_bigger_AF_UNIX = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), AF UNIX",null=True,blank=True)
    ...
    local_bigger_File_reread = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), File reread",null=True,blank=True)
    local_bigger_Mmap_reread = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), Mmap reread",null=True,blank=True)
    local_bigger_Bcopy_libc = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), Bcopy(libc)",null=True,blank=True)
    local_bigger_Bcopy_hand = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), Bcopy(hand)",null=True,blank=True)
    local_bigger_Mem_read = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), Mem read",null=True,blank=True)
    local_bigger_Mem_write = models.FloatField(verbose_name="*Local* Communication bandwidths in MB/s(Bigger is better), Mem write",null=True,blank=True)
