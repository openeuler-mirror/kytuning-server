...
class Cpu2006ViewSet(CusModelViewSet):
    ...
    def get_data(self, serializer_, datas, title_index, column_index, base_column_index):
        ...
        if len(groups) == 1:
            ...
            # 计算每个数组的平均值
            average_base_single_int_400_perlbench = np.mean(base_single_int_400_perlbench_list).round(2) if not base_single_int_400_perlbench_list else None
            average_base_single_int_401_bzip2 = np.mean(base_single_int_401_bzip2_list).round(2) if not base_single_int_401_bzip2_list else None
            average_base_single_int_403_gcc = np.mean(base_single_int_403_gcc_list).round(2) if not base_single_int_403_gcc_list else None
            average_base_single_int_429_mcf = np.mean(base_single_int_429_mcf_list).round(2) if not base_single_int_429_mcf_list else None
            average_base_single_int_445_gobmk = np.mean(base_single_int_445_gobmk_list).round(2) if not base_single_int_445_gobmk_list else None
            average_base_single_int_456_hmmer = np.mean(base_single_int_456_hmmer_list).round(2) if not base_single_int_456_hmmer_list else None
            average_base_single_int_458_sjeng = np.mean(base_single_int_458_sjeng_list).round(2) if not base_single_int_458_sjeng_list else None
            average_base_single_int_462_libquantum = np.mean(base_single_int_462_libquantum_list).round(2) if not base_single_int_462_libquantum_list else None
            average_base_single_int_464_h264ref = np.mean(base_single_int_464_h264ref_list).round(2) if not base_single_int_464_h264ref_list else None
            average_base_single_int_471_omnetpp = np.mean(base_single_int_471_omnetpp_list).round(2) if not base_single_int_471_omnetpp_list else None
            average_base_single_int_473_astar = np.mean(base_single_int_473_astar_list).round(2) if not base_single_int_473_astar_list else None
            average_base_single_int_483_xalancbmk = np.mean(base_single_int_483_xalancbmk_list).round(2) if not base_single_int_483_xalancbmk_list else None
            average_base_single_int_SPECint_2006 = np.mean(base_single_int_SPECint_2006_list).round(2) if not base_single_int_SPECint_2006_list else None
            average_base_single_fp_410_bwaves = np.mean(base_single_fp_410_bwaves_list).round(2) if not base_single_fp_410_bwaves_list else None
            average_base_single_fp_416_gamess = np.mean(base_single_fp_416_gamess_list).round(2) if not base_single_fp_416_gamess_list else None
            average_base_single_fp_433_milc = np.mean(base_single_fp_433_milc_list).round(2) if not base_single_fp_433_milc_list else None
            average_base_single_fp_434_zeusmp = np.mean(base_single_fp_434_zeusmp_list).round(2) if not base_single_fp_434_zeusmp_list else None
            average_base_single_fp_435_gromacs = np.mean(base_single_fp_435_gromacs_list).round(2) if not base_single_fp_435_gromacs_list else None
            average_base_single_fp_436_cactusADM = np.mean(base_single_fp_436_cactusADM_list).round(2) if not base_single_fp_436_cactusADM_list else None
            average_base_single_fp_437_leslie3d = np.mean(base_single_fp_437_leslie3d_list).round(2) if not base_single_fp_437_leslie3d_list else None
            average_base_single_fp_444_namd = np.mean(base_single_fp_444_namd_list).round(2) if not base_single_fp_444_namd_list else None
            average_base_single_fp_447_dealII = np.mean(base_single_fp_447_dealII_list).round(2) if not base_single_fp_447_dealII_list else None
            average_base_single_fp_450_soplex = np.mean(base_single_fp_450_soplex_list).round(2) if not base_single_fp_450_soplex_list else None
            average_base_single_fp_453_povray = np.mean(base_single_fp_453_povray_list).round(2) if not base_single_fp_453_povray_list else None
            average_base_single_fp_454_calculix = np.mean(base_single_fp_454_calculix_list).round(2) if not base_single_fp_454_calculix_list else None
            average_base_single_fp_459_GemsFDTD = np.mean(base_single_fp_459_GemsFDTD_list).round(2) if not base_single_fp_459_GemsFDTD_list else None
            average_base_single_fp_465_tonto = np.mean(base_single_fp_465_tonto_list).round(2) if not base_single_fp_465_tonto_list else None
            average_base_single_fp_470_lbm = np.mean(base_single_fp_470_lbm_list).round(2) if not base_single_fp_470_lbm_list else None
            average_base_single_fp_481_wrf = np.mean(base_single_fp_481_wrf_list).round(2) if not base_single_fp_481_wrf_list else None
            average_base_single_fp_482_sphinx3 = np.mean(base_single_fp_482_sphinx3_list).round(2) if not base_single_fp_482_sphinx3_list else None
            average_base_single_fp_SPECfp_2006 = np.mean(base_single_fp_SPECfp_2006_list).round(2) if not base_single_fp_SPECfp_2006_list else None
            average_base_multi_int_400_perlbench = np.mean(base_multi_int_400_perlbench_list).round(2) if not base_multi_int_400_perlbench_list else None
            average_base_multi_int_401_bzip2 = np.mean(base_multi_int_401_bzip2_list).round(2) if not base_multi_int_401_bzip2_list else None
            average_base_multi_int_403_gcc = np.mean(base_multi_int_403_gcc_list).round(2) if not base_multi_int_403_gcc_list else None
            average_base_multi_int_429_mcf = np.mean(base_multi_int_429_mcf_list).round(2) if not base_multi_int_429_mcf_list else None
            average_base_multi_int_445_gobmk = np.mean(base_multi_int_445_gobmk_list).round(2) if not base_multi_int_445_gobmk_list else None
            average_base_multi_int_456_hmmer = np.mean(base_multi_int_456_hmmer_list).round(2) if not base_multi_int_456_hmmer_list else None
            average_base_multi_int_458_sjeng = np.mean(base_multi_int_458_sjeng_list).round(2) if not base_multi_int_458_sjeng_list else None
            average_base_multi_int_462_libquantum = np.mean(base_multi_int_462_libquantum_list).round(2) if not base_multi_int_462_libquantum_list else None
            average_base_multi_int_464_h264ref = np.mean(base_multi_int_464_h264ref_list).round(2) if not base_multi_int_464_h264ref_list else None
            average_base_multi_int_471_omnetpp = np.mean(base_multi_int_471_omnetpp_list).round(2) if not base_multi_int_471_omnetpp_list else None
            average_base_multi_int_473_astar = np.mean(base_multi_int_473_astar_list).round(2) if not base_multi_int_473_astar_list else None
            average_base_multi_int_483_xalancbmk = np.mean(base_multi_int_483_xalancbmk_list).round(2) if not base_multi_int_483_xalancbmk_list else None
            average_base_multi_int_SPECint_2006 = np.mean(base_multi_int_SPECint_2006_list).round(2) if not base_multi_int_SPECint_2006_list else None
            average_base_multi_fp_410_bwaves = np.mean(base_multi_fp_410_bwaves_list).round(2) if not base_multi_fp_410_bwaves_list else None
            average_base_multi_fp_416_gamess = np.mean(base_multi_fp_416_gamess_list).round(2) if not base_multi_fp_416_gamess_list else None
            average_base_multi_fp_433_milc = np.mean(base_multi_fp_433_milc_list).round(2) if not base_multi_fp_433_milc_list else None
            average_base_multi_fp_434_zeusmp = np.mean(base_multi_fp_434_zeusmp_list).round(2) if not base_multi_fp_434_zeusmp_list else None
            average_base_multi_fp_435_gromacs = np.mean(base_multi_fp_435_gromacs_list).round(2) if not base_multi_fp_435_gromacs_list else None
            average_base_multi_fp_436_cactusADM = np.mean(base_multi_fp_436_cactusADM_list).round(2) if not base_multi_fp_436_cactusADM_list else None
            average_base_multi_fp_437_leslie3d = np.mean(base_multi_fp_437_leslie3d_list).round(2) if not base_multi_fp_437_leslie3d_list else None
            average_base_multi_fp_444_namd = np.mean(base_multi_fp_444_namd_list).round(2) if not base_multi_fp_444_namd_list else None
            average_base_multi_fp_447_dealII = np.mean(base_multi_fp_447_dealII_list).round(2) if not base_multi_fp_447_dealII_list else None
            average_base_multi_fp_450_soplex = np.mean(base_multi_fp_450_soplex_list).round(2) if not base_multi_fp_450_soplex_list else None
            average_base_multi_fp_453_povray = np.mean(base_multi_fp_453_povray_list).round(2) if not base_multi_fp_453_povray_list else None
            average_base_multi_fp_454_calculix = np.mean(base_multi_fp_454_calculix_list).round(2) if not base_multi_fp_454_calculix_list else None
            average_base_multi_fp_459_GemsFDTD = np.mean(base_multi_fp_459_GemsFDTD_list).round(2) if not base_multi_fp_459_GemsFDTD_list else None
            average_base_multi_fp_465_tonto = np.mean(base_multi_fp_465_tonto_list).round(2) if not base_multi_fp_465_tonto_list else None
            average_base_multi_fp_470_lbm = np.mean(base_multi_fp_470_lbm_list).round(2) if not base_multi_fp_470_lbm_list else None
            average_base_multi_fp_481_wrf = np.mean(base_multi_fp_481_wrf_list).round(2) if not base_multi_fp_481_wrf_list else None
            average_base_multi_fp_482_sphinx3 = np.mean(base_multi_fp_482_sphinx3_list).round(2) if not base_multi_fp_482_sphinx3_list else None
            average_base_multi_fp_SPECfp_2006 = np.mean(base_multi_fp_SPECfp_2006_list).round(2) if not base_multi_fp_SPECfp_2006_list else None
            average_peak_single_int_400_perlbench = np.mean(peak_single_int_400_perlbench_list).round(2) if not peak_single_int_400_perlbench_list else None
            average_peak_single_int_401_bzip2 = np.mean(peak_single_int_401_bzip2_list).round(2) if not peak_single_int_401_bzip2_list else None
            average_peak_single_int_403_gcc = np.mean(peak_single_int_403_gcc_list).round(2) if not peak_single_int_403_gcc_list else None
            average_peak_single_int_429_mcf = np.mean(peak_single_int_429_mcf_list).round(2) if not peak_single_int_429_mcf_list else None
            average_peak_single_int_445_gobmk = np.mean(peak_single_int_445_gobmk_list).round(2) if not peak_single_int_445_gobmk_list else None
            average_peak_single_int_456_hmmer = np.mean(peak_single_int_456_hmmer_list).round(2) if not peak_single_int_456_hmmer_list else None
            average_peak_single_int_458_sjeng = np.mean(peak_single_int_458_sjeng_list).round(2) if not peak_single_int_458_sjeng_list else None
            average_peak_single_int_462_libquantum = np.mean(peak_single_int_462_libquantum_list).round(2) if not peak_single_int_462_libquantum_list else None
            average_peak_single_int_464_h264ref = np.mean(peak_single_int_464_h264ref_list).round(2) if not peak_single_int_464_h264ref_list else None
            average_peak_single_int_471_omnetpp = np.mean(peak_single_int_471_omnetpp_list).round(2) if not peak_single_int_471_omnetpp_list else None
            average_peak_single_int_473_astar = np.mean(peak_single_int_473_astar_list).round(2) if not peak_single_int_473_astar_list else None
            average_peak_single_int_483_xalancbmk = np.mean(peak_single_int_483_xalancbmk_list).round(2) if not peak_single_int_483_xalancbmk_list else None
            average_peak_single_int_SPECint_2006 = np.mean(peak_single_int_SPECint_2006_list).round(2) if not peak_single_int_SPECint_2006_list else None
            average_peak_single_fp_410_bwaves = np.mean(peak_single_fp_410_bwaves_list).round(2) if not peak_single_fp_410_bwaves_list else None
            average_peak_single_fp_416_gamess = np.mean(peak_single_fp_416_gamess_list).round(2) if not peak_single_fp_416_gamess_list else None
            average_peak_single_fp_433_milc = np.mean(peak_single_fp_433_milc_list).round(2) if not peak_single_fp_433_milc_list else None
            average_peak_single_fp_434_zeusmp = np.mean(peak_single_fp_434_zeusmp_list).round(2) if not peak_single_fp_434_zeusmp_list else None
            average_peak_single_fp_435_gromacs = np.mean(peak_single_fp_435_gromacs_list).round(2) if not peak_single_fp_435_gromacs_list else None
            average_peak_single_fp_436_cactusADM = np.mean(peak_single_fp_436_cactusADM_list).round(2) if not peak_single_fp_436_cactusADM_list else None
            average_peak_single_fp_437_leslie3d = np.mean(peak_single_fp_437_leslie3d_list).round(2) if not peak_single_fp_437_leslie3d_list else None
            average_peak_single_fp_444_namd = np.mean(peak_single_fp_444_namd_list).round(2) if not peak_single_fp_444_namd_list else None
            average_peak_single_fp_447_dealII = np.mean(peak_single_fp_447_dealII_list).round(2) if not peak_single_fp_447_dealII_list else None
            average_peak_single_fp_450_soplex = np.mean(peak_single_fp_450_soplex_list).round(2) if not peak_single_fp_450_soplex_list else None
            average_peak_single_fp_453_povray = np.mean(peak_single_fp_453_povray_list).round(2) if not peak_single_fp_453_povray_list else None
            average_peak_single_fp_454_calculix = np.mean(peak_single_fp_454_calculix_list).round(2) if not peak_single_fp_454_calculix_list else None
            average_peak_single_fp_459_GemsFDTD = np.mean(peak_single_fp_459_GemsFDTD_list).round(2) if not peak_single_fp_459_GemsFDTD_list else None
            average_peak_single_fp_465_tonto = np.mean(peak_single_fp_465_tonto_list).round(2) if not peak_single_fp_465_tonto_list else None
            average_peak_single_fp_470_lbm = np.mean(peak_single_fp_470_lbm_list).round(2) if not peak_single_fp_470_lbm_list else None
            average_peak_single_fp_481_wrf = np.mean(peak_single_fp_481_wrf_list).round(2) if not peak_single_fp_481_wrf_list else None
            average_peak_single_fp_482_sphinx3 = np.mean(peak_single_fp_482_sphinx3_list).round(2) if not peak_single_fp_482_sphinx3_list else None
            average_peak_single_fp_SPECfp_2006 = np.mean(peak_single_fp_SPECfp_2006_list).round(2) if not peak_single_fp_SPECfp_2006_list else None
            average_peak_multi_int_400_perlbench = np.mean(peak_multi_int_400_perlbench_list).round(2) if not peak_multi_int_400_perlbench_list else None
            average_peak_multi_int_401_bzip2 = np.mean(peak_multi_int_401_bzip2_list).round(2) if not peak_multi_int_401_bzip2_list else None
            average_peak_multi_int_403_gcc = np.mean(peak_multi_int_403_gcc_list).round(2) if not peak_multi_int_403_gcc_list else None
            average_peak_multi_int_429_mcf = np.mean(peak_multi_int_429_mcf_list).round(2) if not peak_multi_int_429_mcf_list else None
            average_peak_multi_int_445_gobmk = np.mean(peak_multi_int_445_gobmk_list).round(2) if not peak_multi_int_445_gobmk_list else None
            average_peak_multi_int_456_hmmer = np.mean(peak_multi_int_456_hmmer_list).round(2) if not peak_multi_int_456_hmmer_list else None
            average_peak_multi_int_458_sjeng = np.mean(peak_multi_int_458_sjeng_list).round(2) if not peak_multi_int_458_sjeng_list else None
            average_peak_multi_int_462_libquantum = np.mean(peak_multi_int_462_libquantum_list).round(2) if not peak_multi_int_462_libquantum_list else None
            average_peak_multi_int_464_h264ref = np.mean(peak_multi_int_464_h264ref_list).round(2) if not peak_multi_int_464_h264ref_list else None
            average_peak_multi_int_471_omnetpp = np.mean(peak_multi_int_471_omnetpp_list).round(2) if not peak_multi_int_471_omnetpp_list else None
            average_peak_multi_int_473_astar = np.mean(peak_multi_int_473_astar_list).round(2) if not peak_multi_int_473_astar_list else None
            average_peak_multi_int_483_xalancbmk = np.mean(peak_multi_int_483_xalancbmk_list).round(2) if not peak_multi_int_483_xalancbmk_list else None
            average_peak_multi_int_SPECint_2006 = np.mean(peak_multi_int_SPECint_2006_list).round(2) if not peak_multi_int_SPECint_2006_list else None
            average_peak_multi_fp_410_bwaves = np.mean(peak_multi_fp_410_bwaves_list).round(2) if not peak_multi_fp_410_bwaves_list else None
            average_peak_multi_fp_416_gamess = np.mean(peak_multi_fp_416_gamess_list).round(2) if not peak_multi_fp_416_gamess_list else None
            average_peak_multi_fp_433_milc = np.mean(peak_multi_fp_433_milc_list).round(2) if not peak_multi_fp_433_milc_list else None
            average_peak_multi_fp_434_zeusmp = np.mean(peak_multi_fp_434_zeusmp_list).round(2) if not peak_multi_fp_434_zeusmp_list else None
            average_peak_multi_fp_435_gromacs = np.mean(peak_multi_fp_435_gromacs_list).round(2) if not peak_multi_fp_435_gromacs_list else None
            average_peak_multi_fp_436_cactusADM = np.mean(peak_multi_fp_436_cactusADM_list).round(2) if not peak_multi_fp_436_cactusADM_list else None
            average_peak_multi_fp_437_leslie3d = np.mean(peak_multi_fp_437_leslie3d_list).round(2) if not peak_multi_fp_437_leslie3d_list else None
            average_peak_multi_fp_444_namd = np.mean(peak_multi_fp_444_namd_list).round(2) if not peak_multi_fp_444_namd_list else None
            average_peak_multi_fp_447_dealII = np.mean(peak_multi_fp_447_dealII_list).round(2) if not peak_multi_fp_447_dealII_list else None
            average_peak_multi_fp_450_soplex = np.mean(peak_multi_fp_450_soplex_list).round(2) if not peak_multi_fp_450_soplex_list else None
            average_peak_multi_fp_453_povray = np.mean(peak_multi_fp_453_povray_list).round(2) if not peak_multi_fp_453_povray_list else None
            average_peak_multi_fp_454_calculix = np.mean(peak_multi_fp_454_calculix_list).round(2) if not peak_multi_fp_454_calculix_list else None
            average_peak_multi_fp_459_GemsFDTD = np.mean(peak_multi_fp_459_GemsFDTD_list).round(2) if not peak_multi_fp_459_GemsFDTD_list else None
            average_peak_multi_fp_465_tonto = np.mean(peak_multi_fp_465_tonto_list).round(2) if not peak_multi_fp_465_tonto_list else None
            average_peak_multi_fp_470_lbm = np.mean(peak_multi_fp_470_lbm_list).round(2) if not peak_multi_fp_470_lbm_list else None
            average_peak_multi_fp_481_wrf = np.mean(peak_multi_fp_481_wrf_list).round(2) if not peak_multi_fp_481_wrf_list else None
            average_peak_multi_fp_482_sphinx3 = np.mean(peak_multi_fp_482_sphinx3_list).round(2) if not peak_multi_fp_482_sphinx3_list else None
            average_peak_multi_fp_SPECfp_2006 = np.mean(peak_multi_fp_SPECfp_2006_list).round(2) if not peak_multi_fp_SPECfp_2006_list else None
