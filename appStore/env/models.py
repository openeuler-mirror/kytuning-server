...
class Env(models.Model):
    ...
    hwinfo_cpu_CPU_family = models.IntegerField(verbose_name='CPU family',null=True,blank=True)
    ...
    hwinfo_memory_mem_freq = models.CharField(max_length=50, verbose_name='mem_freq',null=True,blank=True)
    ...
    swinfo_os_osversion = models.CharField(max_length=50, verbose_name='osversion',null=True,blank=True)
